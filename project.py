...
url = "https://drive.google.com/file/d/1h5EMZTaGM6KnaqrS1Ur6TXUKzdZPYZIm/view?usp=drive_link"

gdown.download(url, "ecg_mlp_model.keras", quiet=False, fuzzy=True)

model = tf.keras.models.load_model("ecg_mlp_model.keras")
